<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('user.update_user_password_title') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __('user.update_user_password_subtitle') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('user.current_password')" />
